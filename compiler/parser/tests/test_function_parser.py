    ...
    #     assert statement.expression.name.name == "Square"
    #     assert isinstance(statement.expression.arguments, list)
    #     assert len(statement.expression.arguments) == 1
    #     assert isinstance(statement.expression.arguments[0], Literal)
    #     assert statement.expression.arguments[0].value == 5
